...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new Componentes.Date.Button();
        cmdTu = new Componentes.Date.Button();
        cmdWe = new Componentes.Date.Button();
        cmdTh = new Componentes.Date.Button();
        cmdFr = new Componentes.Date.Button();
        cmdSa = new Componentes.Date.Button();
        cmdSu = new Componentes.Date.Button();
        cmd1 = new Componentes.Date.Button();
        cmd2 = new Componentes.Date.Button();
        cmd3 = new Componentes.Date.Button();
        cmd4 = new Componentes.Date.Button();
        cmd5 = new Componentes.Date.Button();
        cmd6 = new Componentes.Date.Button();
        cmd7 = new Componentes.Date.Button();
        cmd8 = new Componentes.Date.Button();
        cmd9 = new Componentes.Date.Button();
        cmd10 = new Componentes.Date.Button();
        cmd11 = new Componentes.Date.Button();
        cmd12 = new Componentes.Date.Button();
        cmd13 = new Componentes.Date.Button();
        cmd14 = new Componentes.Date.Button();
        cmd15 = new Componentes.Date.Button();
        cmd16 = new Componentes.Date.Button();
        cmd17 = new Componentes.Date.Button();
        cmd18 = new Componentes.Date.Button();
        cmd19 = new Componentes.Date.Button();
        cmd20 = new Componentes.Date.Button();
        cmd21 = new Componentes.Date.Button();
        cmd22 = new Componentes.Date.Button();
        cmd23 = new Componentes.Date.Button();
        cmd24 = new Componentes.Date.Button();
        cmd25 = new Componentes.Date.Button();
        cmd26 = new Componentes.Date.Button();
        cmd27 = new Componentes.Date.Button();
        cmd28 = new Componentes.Date.Button();
        cmd29 = new Componentes.Date.Button();
        cmd30 = new Componentes.Date.Button();
        cmd31 = new Componentes.Date.Button();
        cmd32 = new Componentes.Date.Button();
        cmd33 = new Componentes.Date.Button();
        cmd34 = new Componentes.Date.Button();
        cmd35 = new Componentes.Date.Button();
        cmd36 = new Componentes.Date.Button();
        cmd37 = new Componentes.Date.Button();
        cmd38 = new Componentes.Date.Button();
        cmd39 = new Componentes.Date.Button();
        cmd40 = new Componentes.Date.Button();
        cmd41 = new Componentes.Date.Button();
        cmd42 = new Componentes.Date.Button();
    ...
    private Componentes.Date.Button cmd1;
    private Componentes.Date.Button cmd10;
    private Componentes.Date.Button cmd11;
    private Componentes.Date.Button cmd12;
    private Componentes.Date.Button cmd13;
    private Componentes.Date.Button cmd14;
    private Componentes.Date.Button cmd15;
    private Componentes.Date.Button cmd16;
    private Componentes.Date.Button cmd17;
    private Componentes.Date.Button cmd18;
    private Componentes.Date.Button cmd19;
    private Componentes.Date.Button cmd2;
    private Componentes.Date.Button cmd20;
    private Componentes.Date.Button cmd21;
    private Componentes.Date.Button cmd22;
    private Componentes.Date.Button cmd23;
    private Componentes.Date.Button cmd24;
    private Componentes.Date.Button cmd25;
    private Componentes.Date.Button cmd26;
    private Componentes.Date.Button cmd27;
    private Componentes.Date.Button cmd28;
    private Componentes.Date.Button cmd29;
    private Componentes.Date.Button cmd3;
    private Componentes.Date.Button cmd30;
    private Componentes.Date.Button cmd31;
    private Componentes.Date.Button cmd32;
    private Componentes.Date.Button cmd33;
    private Componentes.Date.Button cmd34;
    private Componentes.Date.Button cmd35;
    private Componentes.Date.Button cmd36;
    private Componentes.Date.Button cmd37;
    private Componentes.Date.Button cmd38;
    private Componentes.Date.Button cmd39;
    private Componentes.Date.Button cmd4;
    private Componentes.Date.Button cmd40;
    private Componentes.Date.Button cmd41;
    private Componentes.Date.Button cmd42;
    private Componentes.Date.Button cmd5;
    private Componentes.Date.Button cmd6;
    private Componentes.Date.Button cmd7;
    private Componentes.Date.Button cmd8;
    private Componentes.Date.Button cmd9;
    private Componentes.Date.Button cmdFr;
    private Componentes.Date.Button cmdMo;
    private Componentes.Date.Button cmdSa;
    private Componentes.Date.Button cmdSu;
    private Componentes.Date.Button cmdTh;
    private Componentes.Date.Button cmdTu;
    private Componentes.Date.Button cmdWe;
